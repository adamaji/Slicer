...
- Representations
    ...
    - The buttons in each row can be used to create, remove, update a representation
        ...
        - Existing representations can be made master by clicking Make master. The source representation is used as source for conversions, it is the one that can be edited, and saved to disk
